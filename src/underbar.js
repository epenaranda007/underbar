(function() {
  ...
  _.zip = function() {
    ...
    /*return _.reduce(arguments, function(last, curr, index){
        return _.reduce(arguments[index], function(last, curr, index){
          if(!result[index]){
            result[index] = [];
  ...
  _.flatten = function(nestedArray, result) {
    ...
    var value = nestedArray.shift();
    if(Array.isArray(value)){
      result = _.flatten(value, result);
    } else {
      result.push(value);
    }
  ...
  _.intersection = function() {
    var result = [];
    var firstArray = _.first(arguments);
    var otherArrays = Array.from(arguments).slice(1, arguments.length);
    var passed;
